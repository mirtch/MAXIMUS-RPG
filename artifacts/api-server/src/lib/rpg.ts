...
export const DAILY_QUEST_POOL = [
  ...
  { title: "No Social Media Today", description: "Avoid all social media for the entire day", xpReward: 35, statReward: "focus" },
  ...
  { title: "30 Minutes in Silence", description: "No music, no phone, no distractions for 30 minutes", xpReward: 30, statReward: "focus" },
  ...
  { title: "No Junk Dopamine Until 6pm", description: "No YouTube, TikTok, etc. until evening", xpReward: 35, statReward: "focus" },
  ...
  { title: "1 Hour Without Distractions", description: "No music, phone, or distractions for 1 full hour", xpReward: 30, statReward: "focus" },
  ...
  { title: "Deep Work 45 Minutes", description: "45 min of deep focused work, no phone", xpReward: 30, statReward: "focus" },
  { title: "Deep Work 90 Minutes", description: "90 min of uninterrupted deep work", xpReward: 45, statReward: "focus" },
  ...
  { title: "Write About Your Future 20 Min", description: "Write about your goals and future for 20 minutes", xpReward: 25, statReward: "focus" },
  { title: "Plan Your Goals 20 Min", description: "Make a concrete plan for your goals", xpReward: 25, statReward: "discipline" },
  { title: "Spend 20 Min on Finances", description: "Learn about money, investing, or track expenses", xpReward: 20, statReward: "intellect" },
  { title: "Track Your Expenses Today", description: "Record every purchase you make today", xpReward: 15, statReward: "discipline" },
  { title: "Visualize Your Goals 10 Min", description: "Close your eyes and visualize your ideal future", xpReward: 20, statReward: "focus" },
  ...
  { title: "Write 3 Things You Did Well", description: "Reflect on 3 wins from today", xpReward: 15, statReward: "focus" },
  { title: "Write 3 Things to Improve", description: "Identify 3 areas for growth", xpReward: 15, statReward: "focus" },
  ...
  { title: "Write Thoughts Honestly 20 Min", description: "Journal your honest thoughts for 20 minutes", xpReward: 25, statReward: "focus" },
